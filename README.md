...
5. This app has 3 pages - Home Page, Question Page: for questions & Result Page: to view your results.
6. Each question has give 30 second and next button is disabled until all the blanks are filled.If you didn't fill the blanks in the time, then the current quesiton will be skipped & move to the next question.
7. Although your responses will be recorded, for ex if you have filled all the blanks correct, but before you can hit the next button time's up, still your response will be recorded for that question.
